...
const services = [
  {
    ...
    icon: (
      <FaReact className="animate-spin" style={{ animationDuration: "6s" }} />
    ),
  },
  {
  ...
  return (
    <section id="service-section" className="pb-20 md:pt-10" ref={ref}>
      <section className="relative py-8 pb-12">
        {/* Background Gradient */}
        <div
          className="absolute inset-0 mx-22 max-w-7xl bg-linear-to-br from-emerald-900 to-lime-500 rounded-2xl
        ...
        <div className="relative max-w-7xl mx-auto px-8">
          ...
          <div data-aos="zoom-in-down" className="mb-6 text-center">
            ...
            <div
              data-aos="zoom-in"
              className="w-44 h-1 mx-auto mt-2 bg-lime-500 rounded-full"
            />
            <p className="py-4 pb-6 text-gray-200">
              I provide modern design solutions focused on clarity, performance,
              and user experience.
            </p>
          </div>

          {/* Services Grid - Responsive without media query */}
      ...
      <div data-aos="zoom-in-down" className="text-center -mb-8 md:my-4">
        ...
        <div
          data-aos="zoom-in"
          className="w-48 h-1 mx-auto my-2 bg-lime-500 rounded-full"
        />
      </div>
    </section>
  );
